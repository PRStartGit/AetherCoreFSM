"""
Direct test email sender - sends a test email to hello@prstart.co.uk
"""
...
def send_test_email():
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <ul>
                    ...
                    <li>✅ Emails can be sent from hello@zynthio.com</li>
                    <li>✅ Ready for production deployment</li>
                </ul>

                <h3>Next Steps:</h3>
                <ol>
                    <li>Verify domain authentication in SendGrid dashboard</li>
    ...
    try:
        ...
        subject = "✅ SendGrid Test Email - Zynthio Integration Successful"
