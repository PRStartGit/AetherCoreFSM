...
def create_tasks_and_fields(db: Session, categories: list):
    ...
    tasks.extend([
        {
            ...
            "fields": [
                {"field_type": "yes_no", "field_label": "HACCP Plan Reviewed?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Updates Made (if any)", "field_order": 2, "is_required": False}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Records Complete?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Issues Found (if any)", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Hand Washing Procedures Followed?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Issues Observed (if any)", "field_order": 2, "is_required": False}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Staff in Proper Attire?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Issues Found (if any)", "field_order": 2, "is_required": False}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Any Staff Reported Illness?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Details and Action Taken", "field_order": 2, "is_required": False, "show_if": {"field_order": 1, "equals": True}}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Daily Cleaning Completed?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Areas Needing Attention", "field_order": 2, "is_required": False}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Surfaces Sanitized?", "field_order": 1, "is_required": True}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Devices Functional?", "field_order": 1, "is_required": True},
                {"field_type": "yes_no", "field_label": "Any Pest Activity Observed?", "field_order": 2, "is_required": True},
                {"field_type": "text", "field_label": "Details of Pest Activity", "field_order": 3, "is_required": False, "show_if": {"field_order": 2, "equals": True}},
                {"field_type": "photo", "field_label": "Photo Evidence", "field_order": 4, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "FIFO System Working Properly?", "field_order": 1, "is_required": True},
                {"field_type": "yes_no", "field_label": "Any Expired Items Found?", "field_order": 2, "is_required": True},
                {"field_type": "text", "field_label": "Expired Items Removed", "field_order": 3, "is_required": False, "show_if": {"field_order": 2, "equals": True}}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Proper Separation Maintained?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Issues Found (if any)", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Color-Coding Used Correctly?", "field_order": 1, "is_required": True}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Separation Maintained?", "field_order": 1, "is_required": True}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Allergen Information Up-to-Date?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Menu Changes (if any)", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Staff Certified?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Staff Names and Certificate Expiry", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Equipment Operating Properly?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Issues Found (if any)", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Bins Cleaned?", "field_order": 1, "is_required": True}
            ]
        },
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Storage Area Acceptable?", "field_order": 1, "is_required": True}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Hot Water Adequate?", "field_order": 1, "is_required": True},
                {"field_type": "temperature", "field_label": "Temperature (°C)", "field_order": 2, "is_required": False, "validation_rules": {"min": 0, "max": 100}}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "Premises in Good Condition?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Repairs Needed (if any)", "field_order": 2, "is_required": False},
                {"field_type": "photo", "field_label": "Photo Evidence", "field_order": 3, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Suppliers Approved?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Supplier List Review Notes", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    tasks.extend([
        {
            ...
            "has_dynamic_form": True,
            "fields": [
                {"field_type": "yes_no", "field_label": "All Daily Records Complete?", "field_order": 1, "is_required": True},
                {"field_type": "text", "field_label": "Missing Records (if any)", "field_order": 2, "is_required": False}
            ]
        }
    ])
    ...
    for task_data in tasks:
        ...
        for field_data in fields_data:
            ...
            if field_data["field_type"] == "number" and "Number of" in field_data["field_label"]:
            ...
            elif field_data["field_type"] == "repeating_group":
